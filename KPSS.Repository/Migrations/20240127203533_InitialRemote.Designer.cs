...
namespace KPSS.Repository.Migrations
{
    ...
    [Migration("20240127203533_InitialRemote")]
            ...
            modelBuilder.Entity("KPSS.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 1, 27, 23, 35, 33, 918, DateTimeKind.Local).AddTicks(5050),
                            Name = "Pencil 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 1, 27, 23, 35, 33, 918, DateTimeKind.Local).AddTicks(5130),
                            Name = "Pencil 2",
                            Price = 200m,
                            Stock = 30
                        },
